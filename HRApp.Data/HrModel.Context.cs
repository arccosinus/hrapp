...
namespace HRApp.Data
{
    ...
    public partial class HumanResourcesEntities : DbContext
    {
        ...
        public virtual ObjectResult<s_FormerUsers_Result> s_FormerUsers()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<s_FormerUsers_Result>("s_FormerUsers");
        }
